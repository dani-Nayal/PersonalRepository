...
public static double ARTIFACT_CENTER_OFFSET = 2.5;
    ...
    public void init() {
        ...
        if (currentRobot == ROBOTS.INFERNO){
            ...
            pinpoint.setEncoderDirections(GoBildaPinpointDriver.EncoderDirection.REVERSED, GoBildaPinpointDriver.EncoderDirection.REVERSED); //TODO make sure these are correct
